...
public class ListOfMaps {
    ...
    public static void main(String[] args) {
        ...
        for (Map<String, String> eachMap : employees) {  // just write iter and then enter its given for each loop

            for (Map.Entry<String, String> entry : eachMap.entrySet()) { // for then entry then entry
        ...
        for (Map<String, String> map : employees) {
            for (Map.Entry<String, String> entry : map.entrySet()) {
                if(entry.getValue().equals("SDET") || entry.getValue().equals("QA") ){}
